...
- For more details please see Video on live preview or ask us by email...
    ...
    'data': [
        ...
        'data/approval_heirarchy_mails.xml',
        'data/prod_purchasing_request_sequence.xml',
        ...
        'report/purchase_requisition_form.xml',
        'report/purchase_approval.xml',
        'report/purchase_order.xml',
        'views/purchase_requisition_view.xml',
        'views/product_purchasing_request_view.xml',
